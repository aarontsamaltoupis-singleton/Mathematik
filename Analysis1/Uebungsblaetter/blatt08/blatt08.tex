...
\end{align*}
Somit kann es keinen Häufungspunkt $c> \limsup a_{n}$ geben.\\

$\limsup a_{n}$ ist also eine obere Schranke von $H$.\\
Die Folge $(\sup \{a_{m}:m\geq n\})_{n}$ konvergiert per Definition gegen den Wert $\limsup_{a_{n}}$. Somit gilt $\limsup a_{n}\in H$.\\
$\limsup_{a_{n}}$ ist somit das Maximum von $H$ und somit auch das Supremum.
\subsection*{2}

Nach Lemma 4.20 ist $b$ genau dann ein Häufungspunkt, wenn sich in  $B_{\varepsilon }(b)$ unendlich viele Elemente von $(a_{n})_n$ befinden.\\
Sei ein $\varepsilon >0$ gewählt.
Im $\frac{\varepsilon}{2} -$Ball um $b$ befinden sich unendlich viele Häufungspunkte $b_{n}$.\\
Sei der Häufungspunkt $b_{n_{0}}$ mit dem kleinsten Abstand zu $b$ ausgewählt. Im $\frac{\varepsilon }{2}$- Ball um $b_{n_{0}}$ befinden sich unendlich viele Elemente.\\
...
Somit konvergiert auch die Reihe $\sum_{n=1}^{\infty}\frac{(2x)^{n}}{n!}$.
\bigskip
