...
$$\sum_{n=0}^m \sum^n_{k=0}b_n A_{m-n}=
...
\begin{align*}
	\sum^{m+1}_{n=0}\sum^n_{k=0}b_k A_{n-k} & =\sum^{m}_{n=0}\sum^n_{k=0}b_k A_{n-k}+\sum^{m+1}_{n=0}b_n A_{m-n}                                      \\
	                                        & \overset{IH}{=}\sum_{n=0}^mA_{m-n} \sum^m_{n=0} A_{m-n}B_n+ b_0 A_{m+1} + \sum^{m+1}_{n=1}b_n A_{m+1-n} \\
...
\begin{align*}
	|(m_2-m_1)C_{m_2}-\sum^{m_1}_{n=m_1}C_n|<\varepsilon
\end{align*}
...
\begin{align*}
	|AB-\frac{m+1}{m}AB|=|AB(\frac{\varepsilon }{4AB})|\leq \frac{ \varepsilon}{4}
\end{align*}\\
\textbf{Hilfssatz4}\\
Wenn $|F-G|<k $ und $|F'-F|<k $, dann $|F'-G|<2k$
$$2k>|F-G|+|F'-F|\geq |F-G+F'-F|=|F'-G|$$
\\\\
...
\begin{align*}
	\text{Nach Hilfssatz1: }                                                                               \\
	 ...
	 & \textnormal{Nach Hilfssatz 1 und 2:}                                                                \\
